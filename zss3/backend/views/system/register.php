...
<link href="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/css/bg.css" rel="stylesheet" type="text/css" />
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="45" valign="top"><img src="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_03.gif" width="45" height="386" /></td>
    <td width="623" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><img src="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_04.gif" width="623" height="135" /></td>
      </tr>
    </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td background="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_28.gif"><form id="form1" name="form1" method="post" action="">
            <table width="100%" height="158" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td align="center"><table width="272" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td width="123" height="25" align="left"><img src="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_10.gif" width="79" height="17" /></td>
                    <td width="268" align="left"><label>
                      <input name="yhm" id="yhm" type="text" dataType="Limit" require="true" msg="用户名不能为空"  />
                    </label></td>
                  </tr>
                  <tr>
                    <td height="25" align="left"><img src="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_13.gif" width="79" height="18" /></td>
                    <td align="left"><input  name="yhxm" id="yhxm" type="text" dataType="Limit" require="true" msg="用户姓名不能为空"  /></td>
                  </tr>
                  <tr>
                    <td height="25" align="left"><img src="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_15.gif" width="79" height="17" /></td>
                    <td align="left"><input name="mm" id="mm" size="25" type="password" dataType="Limit" require="true" msg="密码不能为空"  /></td>
                  </tr>
                  <tr>
                    <td height="25" align="left"><img src="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_17.gif" width="76" height="19" /></td>
                    <td align="left"><input name="checkmm" id="checkmm" size="25" type="password" dataType="Limit" require="true" msg="确认密码不能为空" /></td>
                  </tr>
                </table></td>
                <td width="232" align="right" valign="top"><img src="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_08.gif" width="232" height="172" /></td>
                </tr>
            </table>
                    <table width="623" height="41" border="0" cellpadding="0" cellspacing="0">
                      <tr align="center">
			<td width="201">&nbsp;</td>
                        <td width="107"><input onClick="javascript:save1();" type="image" src="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_22.gif" width="82" height="23"  /></td>
                        <td width="62"><input onclick="resetform();" type="image" src="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/rr_24.gif" width="62" height="23"></td>
			<td width="201">&nbsp;</td>
                      </tr>
                    </table>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="9"><img src="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_31.gif" width="9" height="44" /></td>
          <td background="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_32.gif">&nbsp;</td>
          <td width="11"><img src="<?php echo Yii::$app->request->baseUrl ?>/assets/user2/images/register_34.gif" width="11" height="44" /></td>
        </tr>
      </table>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
